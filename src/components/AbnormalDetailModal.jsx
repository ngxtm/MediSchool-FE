		...
		>
			<div className="space-y-4">
				<Alert
					message={
						<span>
							<strong>Quan trọng:</strong> Khi đánh dấu "Có bất thường", bạn
							phải cung cấp mô tả chi tiết về phản ứng của trẻ theo quy định báo
							cáo sự kiện bất lợi sau tiêm chủng.
						</span>
					}
					type="error"
					showIcon
				...
				<div>
					<span className="font-medium text-sm">
						...
						<span className="text-blue-600">{recordCount}</span>
					</span>
				</div>

				<div className="flex flex-col gap-2">
					<label htmlFor="followUpNote" className="font-medium text-sm">
						Mô tả chi tiết phản ứng bất thường{" "}
