				...
				<div className="flex flex-col justify-center p-6 pt-20 w-full md:w-1/2 sm:p-8 md:p-10 md:pt-20">
					...
					>
						...
						<button
							...
							className="hover:cursor-pointer w-full bg-white border border-gray-300 text-base font-medium text-gray-700 py-2.5 rounded-md flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
						>
							<svg
								width="20"
								height="20"
