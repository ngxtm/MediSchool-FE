...
const StudentListInEvent = () => {
	...
	const handleSendSelectedEmails = async () => {
		...
		const consentIds = selectedStudents.map(student => {
			...
			render: (_, record) => {
				return (
					<button
						...
						className="flex items-center justify-center w-8 h-8 rounded-full text-teal-600 hover:text-white hover:bg-teal-400 transition-colors duration-200"
					>
