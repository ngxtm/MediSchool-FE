					...
					<Dialog.Content className="fixed left-1/2 top-1/2 w-[90vw] max-w-[650px] -translate-x-1/2 -translate-y-1/2 rounded-md bg-white py-10 px-8 shadow-lg focus:outline-none">
						...
						<div className="flex flex-col gap-6">
							<div className="flex flex-col">
								<label className="font-semibold" htmlFor="name">Tên Vaccine</label>
								<input
									id="name"
							...
							<div className="grid grid-cols-2 gap-4">
								<div className="flex flex-col">
									<label className="font-semibold" htmlFor="manufacturer">Nơi sản xuất</label>
									<input
										id="manufacturer"
										className="input-field"
								...
								<div>
									<label className="font-semibold" htmlFor="dosesRequired">Số liều yêu cầu</label>
									<input
										id="dosesRequired"
										type="number"
										min="1"
							...
							<div>
								<label className="font-semibold" htmlFor="description">Mô tả</label>
								<textarea
									id="description"
									rows={3}
							...
							<div>
								<label className="font-semibold" htmlFor="sideEffects">Triệu chứng sau khi tiêm</label>
								<textarea
									id="sideEffects"
									rows={3}
									className="textarea-field"
							...
							<div>
								<label className="font-semibold" htmlFor="storageTemperature">Nhiệt độ bảo quản</label>
								<input
