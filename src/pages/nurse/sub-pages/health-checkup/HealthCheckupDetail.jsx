...
export default function HealthCheckupDetail() {
  ...
  return (
    <div className="font-inter mx-auto max-w-screen-xl text-gray-900">
            ...
            {eventStatus !== 'PENDING' && (
              <div className="grid grid-cols-2 gap-5">
                <button
                  ...
                  className="rounded-lg bg-[#023E73] px-4 py-2 text-lg font-semibold text-white"
                >
                  Danh sách đơn
                </button>
                <button
      ...
      {isResult && (
        <div className="p-6">
          <table className="w-full overflow-hidden rounded-md border px-3 py-3 text-sm">
            ...
            <tbody>
              {filteredResults.map(item => (
                <tr key={item.resultId} className="border-t text-center hover:bg-gray-50">
