...
export default function HealthCheckupForm() {
  ...
  return (
    <div className="font-inter mx-auto max-w-4xl px-6 py-10">
      <button
        onClick={() => navigate(-1)}
        className="group flex items-center gap-4 rounded-3xl border bg-[#023E73] px-8 py-1 text-base font-bold text-white transition-all duration-200"
      >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-center pt-6">
          <button
            type="submit"
            className="text-m rounded-lg rounded-xl bg-[#023E73] px-5 py-3 font-semibold text-white hover:bg-[#034a8a]"
          >
            Xác nhận
          </button>
        </div>
