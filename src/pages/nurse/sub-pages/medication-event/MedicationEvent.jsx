...
const DialogCreate = ({ classes, students, onClose, onCreateSuccess }) => {
  ...
  return (
    <div className="font-inter fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
      ...
      >
        <div className="rounded-t-2xl bg-gradient-to-r from-[#023E73] to-[#034a8a] px-6 py-6 text-white">
          <h2 className="text-center text-2xl font-bold">TẠO SỰ KIỆN Y TẾ</h2>
          <p className="mt-2 text-center text-blue-100">Ghi nhận và xử lý tình huống sức khỏe học sinh</p>
        </div>

        <div className="p-8">
          <div className="mb-8 rounded-xl bg-blue-50 p-6">
            <h3 className="mb-4 flex items-center text-xl font-bold text-[#023E73]">
              <div className="mr-3 flex h-6 w-6 items-center justify-center rounded-full bg-[#023E73] text-sm font-bold text-white">
                1
              </div>
              Thông tin học sinh
            </h3>
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border px-4 py-3 transition-all duration-200 ${
                      formDate.classSelected
                        ? 'cursor-text border-gray-300 bg-white text-gray-900 focus:border-transparent focus:ring-2 focus:ring-[#023E73] focus:outline-none'
                    ...
                    {filteredMedicines.map(medicine => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <Plus className="h-4 w-4 text-[#023E73]" />
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <div className="rounded-b-2xl border-t border-gray-200 bg-gray-50 px-8 py-6">
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-[#023E73] px-8 py-3 font-medium text-white transition-colors hover:bg-[#01294d]"
            >
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex gap-10">
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#023E73] px-7 py-1.5 text-base font-semibold text-white transition-all duration-200 ease-in-out hover:scale-105 hover:bg-[#01294d] hover:shadow-lg active:scale-95"
          >
            <Plus size={18} />
            Thêm sự kiện y tế
          </button>
                      ...
                      <div className="flex w-full justify-between">
                        ...
                        <div className="flex items-center gap-8">
                          <div className="flex w-fit flex-col justify-center gap-2">
                            ...
                            <button
                              ...
                              className={`flex items-center justify-center gap-2 rounded-lg px-3 py-1.5 text-xs font-semibold transition-all duration-200 ${
                                sendingEmails[event.id]
                                  ...
                                  : 'cursor-pointer bg-[#023E73] text-white hover:bg-[#01294d] hover:shadow-md active:scale-95'
                              }`}
                            >
                              {sendingEmails[event.id] ? (
                                <>
                            ...
                            <p className="text-sm text-gray-500 italic">Thời gian: {formatDateTime(event.eventTime)}</p>
                          </div>
                          <button
                          ...
                          >
                            <ChevronRight
                              size={20}
                              className="text-gray-500 transition-all duration-300 ease-in-out group-hover:translate-x-1 group-hover:scale-110 group-hover:text-[#023E73]"
                            />
                          </button>
                        </div>
                      </div>
