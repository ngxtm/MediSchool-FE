				...
				<Dialog.Content className="fixed left-1/2 top-1/2 max-h-[90vh] w-[90vw] max-w-[630px] -translate-x-1/2 -translate-y-1/2 rounded-md bg-white py-12 px-24 shadow-lg focus:outline-none data-[state=open]:animate-contentShow">
					...
					<div className="flex flex-col">
						<fieldset className="mb-[15px] flex items-center gap-5">
							<label className="w-[210px] text-[15px] font-semibold text-left" htmlFor="eventTitle">
								Tên sự kiện
							</label>
							<input
						...
						<fieldset className="mb-[15px] flex items-center gap-5">
							<label className="w-[210px] text-[15px] font-semibold text-left" htmlFor="vaccineId">
								Loại Vaccine
							</label>
							<Select
						...
						<fieldset className="mb-[15px] flex items-center gap-5">
							<label className="w-[210px] text-[15px] font-semibold text-left" htmlFor="eventScope">
								Phạm vi tiêm chủng
							</label>
							<Select
								className="w-full custom-select"
						...
						<fieldset className="mb-[15px] flex items-center gap-5">
							<label className="w-[210px] text-[15px] font-semibold text-left" htmlFor="eventDate">
								Ngày bắt đầu
							</label>
							<DatePicker
						...
						<fieldset className="mb-[15px] flex items-center gap-5">
							<label className="w-[210px] text-[15px] font-semibold text-left" htmlFor="location">
								Địa điểm
							</label>
							<input
								className="w-full h-[30px] rounded-sm px-3 text-[14px] border-gray-300 leading-none border  outline-none  focus:border-[#1676fb] focus:border-2 placeholder:text-[#bfbfbf]"
									...
									<div className="flex justify-center gap-10 items-center">
										...
										<div className="flex flex-col gap-2">
											<p className="font-bold text-xl">
												{event.eventTitle || event.vaccine?.name || 'Không có tên'}
											</p>
											<p>
												Đối tượng tiêm chủng:{' '}
												{event.eventScope === 'SCHOOL' ? 'Học sinh toàn trường' : 'Theo lớp'}
											</p>
										...
										<div className="flex flex-col gap-2 min-w-[200px] items-center">
											{statusText === 'Đã hủy' ? (
												...
												<>
													...
													<p className="italic">
														Phản hồi: {respondedConsents ?? 'NA'}/{totalConsents ?? 'NA'}{' '}
														học sinh
													</p>
												</>
											)}
