		...
		<div className="flex justify-between gap-4 md:gap-30 md:flex-row flex-col">
			<div className="md:w-1/2">
				...
				<div className={rowWhite}>
					...
					<p className="w-fit">{studentData?.dateOfBirth ? new Date(studentData.dateOfBirth).toLocaleDateString('vi-VN') : 'N/A'}</p>
				</div>
				<div className={rowBlue}>
				...
				<div className={rowWhite}>
					...
					<p className="w-fit">{studentData?.enrollmentDate ? new Date(studentData.enrollmentDate).toLocaleDateString('vi-VN') : 'N/A'}</p>
				</div>
			</div>
			<div className="md:w-1/2">
				...
				<div className={rowBlue}>
					...
					<p className="w-fit">{studentData?.emergencyPhone || 'N/A'} ({studentData?.emergencyContact || 'N/A'})</p>
				</div>
				<div className={rowWhite}>
